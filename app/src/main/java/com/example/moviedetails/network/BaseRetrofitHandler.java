...
import com.example.moviedetails.MyApplication;
...
import static com.example.moviedetails.utils.Config.BASE_URL;
...
public class BaseRetrofitHandler<T> {
    ...
    public void setupRetrofitAndOkHttp() {
        ...
        File httpCacheDirectory = new File(MyApplication.getsAppContext().getCacheDir(), "offlineCache");
